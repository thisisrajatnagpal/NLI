...
import pandas as pd
data = pd.read_csv("data/snli_1.0/snli_1.0_train.csv")
...
np.savetxt('training/premise.txt', x, delimiter=',') 
...
np.savetxt('training/hypothesis.txt', y, delimiter=',') 
...
np.savetxt('training/labels.txt', output, delimiter='\n') 

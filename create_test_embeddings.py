...
import pandas as pd
data = pd.read_csv("data/snli_1.0/snli_1.0_test.csv")
...
np.savetxt('test/premise.txt', x, delimiter=',') 
...
np.savetxt('test/hypothesis.txt', y, delimiter=',') 
...
np.savetxt('test/labels.txt', y, delimiter='\n') 
